...
- Cost optimization must never weaken authorization, tests, persistence integrity, public contracts, CI evidence, security review, or destructive-operation safeguards.
